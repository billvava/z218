...
<style>
    ...
    body{background:url('/Public/mobile/img/czbg.jpg')no-repeat;background-size:100% 100%;}
...
<script type="text/javascript">
    ...
    <script>
        ...
        $('.mycode').click(function(){
            ...
            //     layer.msg('图形验证码错误');
            // }else{
                $.post("<?php echo U('handle/sendCode');?>",{'mobile':phone},function(data){
