...
<div class="mobile">
    ...
    <div class="record_outer">
    	<table>
            ...
            <?php if(is_array($invest)): $i = 0; $__LIST__ = $invest;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                    <td><?php echo ($v["title"]); ?></td>
                    <td><?php echo ($v["money"]); ?></td>
                    <td><?php echo getInvestOrdeStatus($v['stype']);?></td>
                    <!-- <td><a href="<?php echo U('details','id='.$v['id']);?>" class="a1">查看</a></td> -->
                    <!-- <td><a href="<?php echo U('contract','id='.$v['id']);?>" class="a2">查看</a></td> -->
