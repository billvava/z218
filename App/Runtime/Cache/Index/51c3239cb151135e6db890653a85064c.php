...
<style>
    .zhif{width:100%;height:100px;margin-top:10px;}
    .zhif label{width:49%;height:100px;float:left;display:inline-block;text-align: center;}
    .zhif label img{width:75px;}
</style>
<div class="mobile">
	<div class="othertop">
    ...
    <div class="form_outer">
    	...
    	<form action="<?php echo U('form');?>" method="post" id="ifr">
    		...
    		<ul>
    			<li>
    				<label>起投金额</label><span>￥ <em class="start" data-id="<?php echo round($data['min'],2);?>"><?php echo round($data['min'],2);?></em> 元</span>
    			</li>
    			<!-- <li>
                ...
                <div class="blank_card">
                    <label>支付方式</label>
                   <!--  <select name="types" id="bank">
                <option value="1">通道一</option>
                    <option value="2">通道二</option>
                </select> -->
                </div>
                <input type="hidden" id="aa" name="types" value="0">
                <div class="zhif">
                    <label for='a1'>
                        <img src="/Public/mobile/img/zfb.png" alt="" ><br/>
                        <input type="radio" value="1" name="types" id="a1">
                    </label>
                    <label for='a2'>
                        <img src="/Public/mobile/img/zfb.png" alt=""><br/>
                        <input type="radio" value="1" name="types" id='a2'>
                    </label>
                    <!-- <label for='a3'> -->
                        <!-- <img src="/Public/mobile/img/zfb.png" alt=""><br/> -->
                        <!-- <input type="radio" value="3" name="types" id='a3'> -->
                    <!-- </label> -->
                </div>
...
<script>
    $().ready(function(){
        ...
        var addNum = Number($(".start").attr('data-id'));
        ...
        $(".caculate .btn_reduce").click(function(){
            ...
            if(number > minNum){
			 ...
			 msg("错误","投资金额不能小于起投金额",1);
                return false;
			}
        });
        $(".caculate .btn_add").click(function(){
            var number = Number($(this).prev().val());
			// number < maxNum && number < maxNum2 && userMoney > number
            if(number < maxNum && number < maxNum2){
            	number = number + addNum;
                $(this).prev().val(number);
            }
			else{
			 msg("错误","投资金额已达最大投资金额或者系统配置异常",1);
                return false;
			}
        });
        $("#ifr").submit(function(){
