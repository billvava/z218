...
class GsController extends Controller
{
    ...
    public function get_commodity_details()
    {
        ...
        if (I("get.goods_id")) {
            ...
            $this->display('mobile/get_commodity_details');
        } else {
            $this->error("提交方式不对！");
        }
    }
    ...
    public function set_sm_order()
    {
        if (I("get.")) {
            ...
            $this->display('mobile/set_sm_order');
        //  $this->success(1);
        } else {
            $this->error("提交方式不对！");
        }
    ...
    public function sm_order_details()
    {
        ...
        $this->display('mobile/sm_order_details');
    }
    ...
    public function get_order_details()
    {
        if (I("post.")) {
            ...
            foreach ($data['goods'] as $k => $v) {
                ...
                $data['goods'][$k]['add_time']    = date('Y-m-d H:i:s', $v['add_time']);
            }
    ...
    {
        $this->display('monile/sm_address');
    }
